...
model_discrete = torch.load('model_discrete.pth')

model_continuous = torch.load('model_continuous.pth')
...
torch.save(model_discrete, 'model_discrete.pth')
torch.save(model_continuous, 'model_continuous.pth')